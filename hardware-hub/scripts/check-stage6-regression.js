...
function main() {
  ...
  assert.ok(
    ...
    "Installer wajib memverifikasi hash byte-exact Inter Medium approved dari immutable GitHub mirror, menyimpan provenance upstream Inter v3.19, dan membundle OFL.",
  );
  assert.ok(
