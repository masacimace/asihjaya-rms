...
assert.match(buybackManager, /Kadar Belum Memiliki Rate Buyback/);
assert.match(buybackManager, /BadgeDollarSign/);
assert.match(buybackManager, /ChevronDown/);
assert.match(buybackManager, /filteredMissingRows/);
assert.match(buybackManager, /newBuybackPurityPercent/);
assert.match(buybackManager, /Atur Rate/);
assert.match(buybackManager, /Master kadar emas aktif/);
