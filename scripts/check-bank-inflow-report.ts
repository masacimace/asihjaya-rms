...
assert.match(pageSource, /Filter laporan/);
assert.match(pageSource, /activeFilterCount/);
...
assert.match(pageSource, /Dampak bersih/);
assert.match(pageSource, /getPaginationTokens/);
...
assert.doesNotMatch(pageSource, /min-w-\[(?:820|1220)px\]/);
...
console.log("Bank Inflow report contracts: OK — compact cards + responsive pagination.");
