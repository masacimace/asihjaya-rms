            ...
            <tbody className="divide-y divide-[var(--border)]">
              {overview.deliveries.map((delivery) => (
                <tr key={delivery.id} className="align-top">
                  ...
                  <td className="px-3 py-3">
                    <Link href={`/admin/integrasi/telegram/delivery/${delivery.id}`} className="inline-flex items-center gap-1 text-xs font-semibold text-[var(--accent)] hover:underline">
