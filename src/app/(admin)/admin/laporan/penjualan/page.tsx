        ...
        <table className="min-w-full divide-y divide-neutral-100 text-left text-sm">
          <thead className="bg-neutral-50 text-xs uppercase tracking-wide text-neutral-500">
            <tr>
              ...
              <th className="px-5 py-3 text-right font-semibold">Laba</th>
          ...
          <tbody className="divide-y divide-neutral-100 bg-white">
            {rows.length === 0 ? (
              ...
              rows.map((sale) => (
                <tr key={sale.id} className="transition hover:bg-neutral-50/70">
                  ...
                  <td className="whitespace-nowrap px-5 py-4 text-right font-semibold text-neutral-950">
            ...
            <article key={sale.id} className="p-5">
              ...
              <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="text-left sm:text-right">
                  ...
                  <p className="mt-1 text-xs text-[var(--muted)]">
                    Laba {formatMoney(sale.grossProfit)}
                  </p>
                </div>
              </div>
            </article>
      ...
      <section className="rounded-[2rem] border border-[var(--border)] bg-white p-5 sm:p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full bg-neutral-100 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-neutral-600">
              R11B · Real-data sales report
            </div>
