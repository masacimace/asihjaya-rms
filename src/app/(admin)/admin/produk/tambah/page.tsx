        ...
        <div className="mt-5 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--muted)]">
              Buat barang fisik langsung dari satu form. Pilih kategori dan
              Product Master, atau buat Product Master baru dari tombol + jika
              belum tersedia.
            </p>
          </div>
          ...
          <div className="grid min-w-[260px] gap-2 rounded-2xl border border-[var(--border)] bg-[var(--surface-muted)] p-4 text-xs text-neutral-700">
            <div className="flex items-start gap-2">
              ...
              Product Master baru bisa dibuat langsung dari form tanpa pindah
              halaman.
            </div>
            <div className="flex items-start gap-2">
