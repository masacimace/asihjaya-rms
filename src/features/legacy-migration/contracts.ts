...
export const LEGACY_PRODUCT_IMPORT_MAX_COLUMNS = 100;
export const LEGACY_PRODUCT_IMPORT_MAX_WORKSHEETS = 5;
export const LEGACY_PRODUCT_IMPORT_MAX_FORMULA_LENGTH = 4_000;
export const LEGACY_PRODUCT_IMPORT_MAX_HYPERLINK_LENGTH = 2_000;
export const LEGACY_PRODUCT_IMPORT_MAX_RAW_CELL_LENGTH = 4_000;
