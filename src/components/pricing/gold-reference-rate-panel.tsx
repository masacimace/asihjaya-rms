...
function formatComparisonLabel(value: string | null) {
  ...
  return `vs ${new Intl.DateTimeFormat("id-ID", {
    day: "numeric",
    month: "short",
    timeZone: "Asia/Jakarta",
  }).format(date)}`;
...
export function GoldReferenceRatePanel({
  result,
}: {
  result: GoldReferenceResult;
}) {
          ...
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs leading-5 text-[var(--muted)]">
                Benchmark eksternal 1 gram untuk membantu meninjau Rate Global.
                Rate ASIHJAYA tetap diatur manual.
              </p>
            </div>
          </div>
  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-[var(--border)] bg-white">
      <div className="flex flex-col gap-4 p-4 sm:p-5 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-xs leading-5 text-[var(--muted)]">
              ...
              sebagai benchmark saat meninjau Rate Global.
            </p>
          </div>
        </div>
        ...
        <label className="min-w-0 lg:min-w-[240px]">
          ...
          <span className="relative block">
            <select
              aria-label="Pilih referensi harga emas untuk Harga per Gram"
      ...
      <div className="grid border-t border-[var(--border)] md:grid-cols-3">
        <div className="border-b border-[var(--border)] p-4 md:border-b-0 md:border-r sm:p-5">
