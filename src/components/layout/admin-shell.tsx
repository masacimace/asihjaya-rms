  ...
  return (
    ...
    >
      ...
      <div className="flex h-dvh min-h-0 min-w-0 max-w-full flex-col overflow-hidden">
        {/* Topbar */}
        <header className="relative z-50 flex h-[72px] w-full max-w-full min-w-0 shrink-0 items-center overflow-visible border-b border-[var(--border)] bg-white/95 px-1.5 backdrop-blur sm:px-4 lg:px-4">
          <button
            type="button"
